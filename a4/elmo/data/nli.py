...
class NLIDataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        if stage == 'fit' or stage is None:
            self.data_train = NLIDataset(data_dir=self.data_dir, split_name='train')
            self.data_val = NLIDataset(data_dir=self.data_dir, split_name='validation')
        if stage == 'test':
            self.data_test = NLIDataset(data_dir=self.data_dir, split_name='test')
